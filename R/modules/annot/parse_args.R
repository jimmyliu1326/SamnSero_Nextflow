...
plasmid_res_path <- file.path(annot_dir, "results", "mob_suite_res_aggregate.tsv")
amr_res_path <- file.path(annot_dir, "results", "rgi_res_aggregate.tsv")
vf_res_path <-  file.path(annot_dir, "results", "vfdb_res_aggregate.tsv")

# get file names for aggregated results and summary results
annot_res_files <- list.files(file.path(annot_dir, "results"), pattern = "_aggregate")
annot_summary_files <- list.files(file.path(annot_dir, "summary"))
