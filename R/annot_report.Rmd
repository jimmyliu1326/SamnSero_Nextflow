...
if (tryCatch(nrow(amr_summary) == 0, error = function(e) return(T))) {
...
if (tryCatch(nrow(vf_summary) == 0, error = function(e) return(T))) {
...
if (tryCatch(nrow(plasmid_summary) == 0, error = function(e) return(T))) {
...
if (tryCatch(nrow(tidy_res != 0), error = function(e) return(T))) {
