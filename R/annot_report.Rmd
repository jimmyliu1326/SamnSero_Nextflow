...
```{r amr-heatmap-var-plot, eval=heatmap_eval, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'right'}
...
```{r amr-heatmap-plot,  fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'right', eval = heatmap_eval}
draw(p, heatmap_legend_side = "top",annotation_legend_side = "left")
```
</div>
...
```{r amr-drug-heatmap-plot, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'right', eval=heatmap_eval}
draw(p, heatmap_legend_side = "top", annotation_legend_side = "left")
```
</div>
...
```{r vf-heatmap-var-plot, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'center', eval=heatmap_eval}
draw(p, heatmap_legend_side = "top", annotation_legend_side = "left")
```
</div>
...
```{r vf-heatmap-plot, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'center', eval=heatmap_eval}
draw(p, heatmap_legend_side = "top", annotation_legend_side = "left")
```
</div>
