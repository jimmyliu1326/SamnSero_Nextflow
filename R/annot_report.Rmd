...
if (tryCatch(ncol(amr_summary) <= 1, error = function(e) return(T))) {
...
if (tryCatch(ncol(vf_summary) <= 1, error = function(e) return(T))) {
...
if (tryCatch(ncol(plasmid_summary) <= 1, error = function(e) return(T))) {
