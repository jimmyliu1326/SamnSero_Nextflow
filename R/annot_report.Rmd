...
if (interactive != 0) {
	args <- c("../data/samnsero_annot/sistr_res_aggregate.csv",
						"../data/samnsero_annot/annotations/")
} else {
...
```{r amr-heatmap-var-plot, eval=heatmap_eval, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'center'}
...
```{r amr-heatmap-plot,  fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'center', eval = heatmap_eval}
draw(p, heatmap_legend_side = "top",annotation_legend_side = "left")
```
</div>
...
```{r amr-drug-heatmap-plot, fig.width = p_dim[1], fig.height = p_dim[2]+1, fig.align = 'center', eval=heatmap_eval}
draw(p, heatmap_legend_side = "top", annotation_legend_side = "left")
```
</div>
