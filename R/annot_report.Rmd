...
<div class="container">
```{r vf-heatmap}
if (tryCatch(nrow(amr_summary) == 0 | ncol(vf_summary) <= 1, error = function(e) return(T))) {
...
<div class="container">
```{r plasmid-heatmap}
if (tryCatch(nrow(amr_summary) == 0 | ncol(plasmid_summary) <= 1, error = function(e) return(T))) {
...
<div class="container">
```{r full-heatmap}
if (tryCatch(ncol(tidy_res) <= 1, error = function(e) return(T))) {
