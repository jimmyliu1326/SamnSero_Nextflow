...
if (Sys.getenv("RSTUDIO") == "1") {
	args <- c("../data/samnsero_qc_062023/checkm_res_aggregate.tsv",
						"../data/samnsero_qc_062023/quast_res_aggregate.tsv",
						"../data/samnsero_qc_062023/sistr_res_aggregate.csv",
						"../data/samnsero_qc_062023/target_reads_aggregate.csv",
						"../data/samnsero_qc_062023/kreport")
} else {
